    ...
    <div class="modal-dialog ">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form action="{{route('criteria.simpan')}}" id="addForm" method="POST">
            @csrf
            <div class="form-group mb-3">
              <label for="kode" class="mb-1">Kode Kriteria</label>
            ...
            <div class="form-group mb-3">
              <label for="bobot" class="mb-1">Bobot</label>
              <input required class="form-control" type="number" name="bobot" step="any" id="bobot"
                placeholder="Masukkan Bobot Kriteria" />
            </div>
            <div class="form-group mb-3">
              <label for="benefited" class="mb-1">Jenis</label>
