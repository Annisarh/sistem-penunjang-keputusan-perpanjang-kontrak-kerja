...
<head>
    ...
    <title>Criteria Perhitungan SPK Salesman TOPSIS</title>
    <style>
      .header{
        padding: 5px;
        text-align: center;
...
<body>
  ...
  <hr style="border: 0px; height: 3px; color: #333; background-color:#333;">
    <h3 style="text-align: center">Data Kriteria Perhitungan</h3>
      <table style="width: 90%; margin-right: auto; margin-left: auto; margin-top: 25px" border="1" cellpadding="2" cellspacing="0">
        ...
        <tbody>
          ...
          <tr>
            <td align="center">{{$criteria->kode}}</td>
            <td>{{$criteria->nama}}</td>
            <td align="center">{{$criteria->bobot}}</td>
          </tr>
          @endforeach
        </tbody>
      </table>
    <div class="footer" style="display: flex; justify-content: space-between">
      {{-- <div style="margin-top: 20px; text-align:center; margin-left:70px;"><a href="{{route('dowexportPdf')}}">ExportPDF</a></div> --}}
